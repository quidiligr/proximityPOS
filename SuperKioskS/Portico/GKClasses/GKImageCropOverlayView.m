...
- (void)drawRect:(CGRect)rect{
    ...
    if (heightSpan > 30 && (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)) {
        ...
        */
        ...
        [NSLocalizedString(@"GKImoveAndScale", @"") drawInRect:CGRectMake(10, (height - heightSpan) + (heightSpan / 2 - 20 / 2) , width - 20, 20) withAttributes:@{NSFontAttributeName:font,NSParagraphStyleAttributeName:textStyle,NSForegroundColorAttributeName:self.tintColor}];
