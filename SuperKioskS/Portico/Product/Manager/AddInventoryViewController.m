...
@interface AddInventoryViewController () <UITableViewDataSource, UITableViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate>{
...
- (void)viewDidLoad {
    ...
    _saveButton=[[UIBarButtonItem alloc] initWithTitle:@"Save" style:UIBarButtonItemStyleBordered target:self action:@selector(completeButtonTapped:)];
    hasChanged=NO;
    ...
    //TODO: We accept Visa, Mastercard, Amex and Discovery.
        ...
        return nil;
            ...
            switch(row){
                ...
                case 3:
                {
                    ...
                    cell.textField.text=[Util decimalDisplay:salesTax];
                ...
                case 6:
                {
                    ...
                    //if(minChargeAmount)
                        cell.textField.text=[Util decimalDisplay:minChargeAmount/100];//[NSString stringWithFormat:@"%@",@(minChargeAmount)];
                    //else
                     //   cell.textField.text=@"";
                    cell.textField.placeholder = @"Required";
                ...
                case 7:
                {
                    ...
                    //if(maxChargeAmount)
                        cell.textField.text=[Util decimalDisplay:maxChargeAmount/100];//[NSString stringWithFormat:@"%@",@(maxChargeAmount)];
                    //else
                    //    cell.textField.text=@"";
                    cell.textField.placeholder = @"Required";
