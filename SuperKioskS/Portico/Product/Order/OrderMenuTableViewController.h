...
@interface OrderMenuTableViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate,BCScannerViewControllerDelegate,SearchMenuViewControllerDelegate,SelectOneViewControllerDelegate,UIActionSheetDelegate> {
...
-(void)orderViewControllerDidFinish:(OrderMenuTableViewController *)orderViewController;

-(void)orderViewControllerWasCancelled:(OrderMenuTableViewController *)orderViewController;
