...
@implementation MenuCategoryProductsViewController
{
...
- (void)viewDidLoad
{
    ...
    */
    _searchButtonItem=[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"Search"] style:UIBarButtonItemStyleBordered target:self action:@selector
                       (showBrowserAction)];
    
    //self.navigationItem.leftBarButtonItem=_searchButtonItem;
    //self.navigationItem.leftBarButtonItems=@[_backButtonItem,_searchButtonItem];
    ...
    self.navigationItem.rightBarButtonItems=@[_searchButtonItem,_menuButtonItem];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    */
    if(_selectedCategory){
        return [_selectedCategory.products count ];
    }
    else{
        return 0;
    }
...
- (UICollectionReusableView *)viewForHeaderInSection:(NSIndexPath *)indexPath{
    ...
    */
    ...
    if(_selectedCategory.pictureFile.length>0){
        ...
        NSString *filePath=[[AppDelegate getImagesPathForServer:_appDelegate.selectedStore.peerInfo.deviceID] stringByAppendingPathComponent:_selectedCategory.pictureFile];
        if([[NSFileManager defaultManager] fileExistsAtPath:filePath])
        {
        ...
        else
        {
            ...
            //dispatch_async(dispatch_get_main_queue(), ^{
            NSString *serverPath=[NSString stringWithFormat:@"images/%@",_selectedCategory.pictureFile];
    ...
    */
    ...
    if(_selectedCategory.detail){
        //cell=[tableView dequeueReusableCellWithIdentifier:@"MenuSectionNoImageCell"];
        cell.descriptonLabel.text=_selectedCategory.detail;
    }
    else {
    ...
    cell.nameLabel.text =_selectedCategory.name;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Product *product=[_selectedCategory.products objectAtIndex:indexPath.row];//[[Product alloc] initWithDictionary:[sectionProducts objectAtIndex:indexPath.row]];
