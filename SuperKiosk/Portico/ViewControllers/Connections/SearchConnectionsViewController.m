...
#import "SearchConnectionsViewController.h"
...
@implementation SearchConnectionsViewController
{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.delegate searchConnectionsViewControllerItemSelected:self item:selectedProduct];
