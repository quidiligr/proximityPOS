...
#import "MessageWithMediaNoTextCell.h"
//#import "Message.h"
...
@interface MessageWithMediaNoTextCell() {
...
@implementation MessageWithMediaNoTextCell

+ (void)initialize
{
	if (self == [MessageWithMediaNoTextCell class])
	{
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString*)reuseIdentifier
{
	if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]))
	{
       ...
       // [self.contentView addSubview:_btnPlayer];
...
- (void)setMessage:(MessageTableViewData*)message {
   ...
   // CGRect rectMedia=_btnPlayer.frame;
    ...
    //[_btnPlayer setImage:message.myMedia forState:UIControlStateNormal];
     [_imgPlayer setImage:message.myMedia];
