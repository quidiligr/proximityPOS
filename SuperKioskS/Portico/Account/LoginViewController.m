...
-(void)viewDidAppear:(BOOL)animated{
    ...
    _appDelegate.appConfig.user_userToken=nil;
    //ROM: change this on prod
    
    //self.nicknameTextField.text =@"tastywokcuisine1";
    //self.secretCodeTextField.text =@"tastywokcuisine1";
    
    //self.nicknameTextField.text =@"sharkeysnightclub";
    //self.secretCodeTextField.text =@"sharkeysnightclub";
    
    //self.nicknameTextField.text =@"busbyswest";
    //self.secretCodeTextField.text =@"busbyswest";
    
    //self.nicknameTextField.text = @"clementine";
    //self.secretCodeTextField.text = @"clementine";
    
    //self.nicknameTextField.text = @"mcdonalds";
    //self.secretCodeTextField.text = @"mcdonalds";
    
    self.nicknameTextField.text = @"starbucks";
    self.secretCodeTextField.text = @"starbucks";
    
    //self.nicknameTextField.text = @"kingmakerfoods2";//@"wilson4";
    //self.secretCodeTextField.text = @"kingmakerfoods2";//=@"wilson4";
    
    //self.nicknameTextField.text =@"sharkeysnightclub";//@"tastywokcuisine1";//@"sharkeysnightclub";//@"starbucks";@"rquidilig";// _appDelegate.appConfig.user_username;
    
    
   // self.secretCodeTextField.text =@"sharkeysnightclub";//@"tastywokcuisine1";//@"sharkeysnightclub";//@"starbucks";@"t@ught11";//_appDelegate.appConfig.user_password;

    //self.nicknameTextField.text =@"starbucks";//@"starbucks";@"rquidilig";// _appDelegate.appConfig.user_username;
    //self.secretCodeTextField.text =@"starbucks";//@"starbucks";@"t@ught11";//_appDelegate.appConfig.user_password;
    /*
    self.nicknameTextField.text =@"sharkeysnightclub";//@"starbucks";@"rquidilig";// _appDelegate.appConfig.user_username;
    self.secretCodeTextField.text =@"sharkeysnightclub";//@"starbucks";@"t@ught11";//_appDelegate.appConfig.user_password;
*/
...
- (void)postGenerateKeyRequest
{
    ...
    */
    NSError *error;
     ...
     ,_appDelegate.appConfig.user_key
     ,_appDelegate.appConfig.device_uuid
     ,_appDelegate.appConfig.device_id
     ,(_appDelegate.appConfig.device_token==nil)?@"":_appDelegate.appConfig.device_token];
...
- (void)postLoginRequest
{
    ...
    NSError *error;
    NSString *info=[NSString stringWithFormat:@"username=%@&password=%@&deviceuuid=%@&deviceid=%@&devicetoken=%@&devicename=%@&menuid=%@&lat=%@&lng=%@"
                    ...
                    ,_appDelegate.appConfig.device_id
                    ,(_appDelegate.appConfig.device_token==nil)?@"":_appDelegate.appConfig.device_token
                    ,[_appDelegate.appConfig.device_name stringByReplacingOccurrencesOfString:@"&" withString:@"%26"]
                    ,@(_appDelegate.appConfig.device_menuid)
                    ,[NSString stringWithFormat:@"%f",_appDelegate.appConfig.device_lat]
                    ,[NSString stringWithFormat:@"%f",_appDelegate.appConfig.device_lng]];
...
- (void)postQueryMyDeviceInfo
{
    ...
    NSDictionary *params = @{@"cmd":@"110",
                             ...
                             @"deviceid": _appDelegate.appConfig.device_id//_appDelegate.userInfo.deviceID//,
                  ...
                  if ([self isViewLoaded]) {
                      ...
                      if([operation.response statusCode] != 200) {
                          ...
                          if([success intValue]==1){
                              ...
                              _appDelegate.appConfig.device_phone=DICT_GET(jsondevice, @"phone");
...
- (IBAction)loginAction
{
    ...
    */
    ...
    _appDelegate.appConfig.user_password=self.secretCodeTextField.text;
