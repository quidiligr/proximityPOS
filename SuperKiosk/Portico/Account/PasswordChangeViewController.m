...
- (void)postPasswordChange
{
    ...
    */
    ...
    NSDictionary *params = @{@"cmd":@"112",
                             @"username":_appDelegate.appConfig.userInfo.username,//_datamodel.userInfo.username ,
             ...
             if([operation.response statusCode] != 200) {
                 ...
                 if([success intValue]==1){
                    ...
                    // NSManagedObjectContext *context=[self managedObjectContext];
                     ...
                     _appDelegate.appConfig.userInfo.password_hash=pwdHash;
                     //_appDelegate.appConfig.user_username=self.nicknameTextField.text;
                     _appDelegate.appConfig.userInfo.password=self.yourPassword.text;
