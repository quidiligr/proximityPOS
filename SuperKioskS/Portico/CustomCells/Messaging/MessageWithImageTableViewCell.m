...
@interface MessageWithImageTableViewCell() {
...
@implementation MessageWithImageTableViewCell

+ (void)initialize
{
	if (self == [MessageWithImageTableViewCell class])
	{
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString*)reuseIdentifier
{
	...
	{
		self.selectionStyle = self.selectionStyle = UITableViewCellSelectionStyleNone;//UITableViewCellSelectionStyleGray;//UITableViewCellSelectionStyleNone;
...
- (void)setMessage:(MessageTableViewData*)message{
   BOOL isPrivate=message.isPrivate;
    ...
    if([message.userid isEqualToNumber:message.senderid])
	{
        ...
        rectPhoto.origin.y=point.y;//rectImage.size.height+CELL_VERTICAL_SPACE;
