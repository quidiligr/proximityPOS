...
@interface BroadcastMessageAPI : NSObject<NSCoding>
...
@property(nonatomic,strong) NSString *fromDeviceID;
...
@property (nonatomic, assign) BOOL isServer; //use in remote notification to identify if message is coming from a server or not
...
@property (nonatomic, copy) NSString* senderid_origin;
