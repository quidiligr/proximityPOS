...
@protocol SearchConnectionsViewControllerDelegate;
//@class Order;
//@class CheckoutCart;

@interface SearchConnectionsViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate> //{
    //int currentItemIndex;
//}

//@property (strong, nonatomic) NSDictionary* inventory;
////@property (strong, nonatomic) Order* order;
@property (nonatomic, assign) id<SearchConnectionsViewControllerDelegate> delegate;
...
@protocol SearchConnectionsViewControllerDelegate <NSObject>

-(void)searchConnectionsViewControllerItemSelected:(SearchConnectionsViewController *)controller item:(Product *)item;
/*
