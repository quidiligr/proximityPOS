...
//	}
    NSDictionary *params = @{@"cmd":@"111",
                             @"username":self.email ,
                             @"devicetoken": _appDelegate.appConfig.userInfo.deviceToken, //_datamodel.userInfo.devicetoken,
             ...
             if([operation.response statusCode] != 200) {
                 ...
                 if([success intValue]==1){
                     ...
                     */
                     ...
                     _appDelegate.appConfig.userInfo.password_tmp=message; //_datamodel.tmpPassword=message;
                    // [_datamodel.context save:nil];
