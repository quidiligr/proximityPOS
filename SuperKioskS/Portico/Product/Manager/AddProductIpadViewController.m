...
#import "defs.h"
#define PlaceHolderText  @"Your shorty description here"

@interface AddProductIpadViewController (){
...
@implementation AddProductIpadViewController
...
- (void)viewDidLoad {
    ...
    _priceTextField.text=[Product priceToString:(double)_selectedProduct.price/100]; //[NSString stringWithFormat:@"%.2f",(double)_selectedProduct.price/100];
    _priceTextField.delegate=self;
    
    _discountedPriceLabel.text=[NSString stringWithFormat:@"Discounted: %@",[Product priceToString:(double)_selectedProduct.price/100]];
