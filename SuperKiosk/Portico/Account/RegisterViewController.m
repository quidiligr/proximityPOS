...
- (void)postStartRegistration
{
   ...
   // self.kioskName.text=[self.kioskName.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    ...
    self.dob.text=[self.dob.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    ...
    self.address.text=[self.address.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    ...
    */
    _appDelegate.appConfig.userInfo.username=self.userName.text;
    _appDelegate.appConfig.userInfo.firstname=self.firstName.text;
    _appDelegate.appConfig.userInfo.lastname=self.lastName.text;
    //NSError *error;
